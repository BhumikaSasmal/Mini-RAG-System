...
| Source Display | What are roles and responsibilities? |  Pass | Returns the relevant "Roles and Responsibilities" section with associated source references. | `sample_report.pdf (Page 1, p2_c3)`, `sample_policy.txt (N/A, c2)`, `sample_report.pdf (Page 2, p1_c0)` |
